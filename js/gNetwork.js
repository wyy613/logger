...
function initInvNum () {
    Ajax.get(`/net_face_post`, function (c) {
        c = JSON.parse(c)
        console.log(c)
        if (c.type == 4) {
...
function wlanset () {
    ...
    set_butt.onclick = function () {
        if (set_butt.style.cursor == 'pointer') {
            ...
            Ajax.post(`/net_set`, JSON.stringify(diswlanobj), function (c) {
                c = JSON.parse(c)
                console.log(c)
                if (c.state == 1) {
...
function lanset () {
    ...
    set_butt.onclick = function () {
        if (set_butt.style.cursor == 'pointer') {
            ...
            Ajax.post(`/net_set`, JSON.stringify(obj), function (c) {
                c = JSON.parse(c)
                console.log(c)
                if (c.state == 1) {
                    showMessage(getPrompt("setSucc"), 2000, 'succContent', '&#xe616;')
...
function landhcpButton () {
    ...
    set_butt.onclick = function () {
        if (set_butt.style.cursor == 'pointer') {
            ...
            var res = alloptionsvalue.indexOf(usbFlashValue)
            objlan.dhcp = res
            Ajax.post(`/net_set`, JSON.stringify(objlan), function (c) {
                c = JSON.parse(c)
                console.log(c)
                if (c.state == 1) {
                    showMessage(getPrompt("setSucc"), 2000, 'succContent', '&#xe616;')
...
function enable4g () {
    ...
    set_butt.onclick = function () {
        ...
        if (set_butt.style.cursor == 'pointer') {
            ...
            Ajax.post(`/net_set`, JSON.stringify(obj4g), function (c) {
                c = JSON.parse(c)
                console.log(c)
                if (c.state == 1) {
                    showMessage(getPrompt("setSucc"), 2000, 'succContent', '&#xe616;')
...
nextpage.addEventListener('click', function () {
    ...
    parentDoc.querySelectorAll('.nav2li')[5].click()
